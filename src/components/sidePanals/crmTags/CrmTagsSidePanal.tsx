...
const navItems: TagsCrmsNavItem[] = [
  { id: 'all-crm-tags', label: 'All', icon: <Zap size={16} /> },
  { id: 'mission-crm-tags', label: 'Missions', icon: <Trophy size={16} /> },
  { id: 'ranks-crm-tags', label: 'Ranks', icon: <Flag size={16} /> },
  { id: 'reward-shop-crm-tags', label: 'Reward Shop', icon: <Send size={16} /> },
  { id: 'token-rules-crm-tags', label: 'Token Rules', icon: <Settings size={16} /> },
  { id: 'tournaments-crm-tags', label: 'Tournaments', icon: <LayoutGrid size={16} /> },
  { id: 'xp-points-crm-tags', label: 'XP Points', icon: <LayoutGrid size={16} /> },
];
