...
const TimezoneRow = ({ description, value }: Props) => (
  <div className="flex items-center justify-between bg-slate-800 border border-slate-700 rounded-lg px-5 py-4 hover:border-slate-500 transition-colors">
    ...
    <div className="ml-4 flex-shrink-0">
      <button className="flex items-center gap-2 bg-slate-700 hover:bg-slate-600 border border-slate-600 text-slate-200 text-xs px-3 py-2 rounded-md transition-colors">
